...
class SolarSystemSimulation {
	...
	private static generateSolarSystem() {
		let bodies: Body[] = [
			...
			new Body(3.30e23,  PLANET_GEOMETRY, new Vec2(0, 5.790e10)), //Mercury
			new Body(4.87e24,  PLANET_GEOMETRY, new Vec2(0, 1.082e11)), //Venus
			new Body(5.97e24,  PLANET_GEOMETRY, new Vec2(0, 1.496e11)), //Earth
			new Body(6.42e23,  PLANET_GEOMETRY, new Vec2(0, 2.280e11)), //Mars
			new Body(1.898e27, PLANET_GEOMETRY, new Vec2(0, 7.785e11)), //Jupiter
			new Body(5.68e26,  PLANET_GEOMETRY, new Vec2(0, 1.432e12)), //Saturn
			new Body(8.68e25,  PLANET_GEOMETRY, new Vec2(0, 2.867e12)), //Uranus
			new Body(1.02e26,  PLANET_GEOMETRY, new Vec2(0, 4.515e12)) //Neptune
		];

		bodies[1].v = new Vec2(-47400, 0); //Mercury
		...
		let characteristics: SolarSystemPlanetCharacteristics[] = [
			...
			new SolarSystemPlanetCharacteristics(2439500, "#adb5bd"), //Mercury
			new SolarSystemPlanetCharacteristics(6052000, "#ffc078"), //Venus
			new SolarSystemPlanetCharacteristics(6378000, "#1864ab"), //Earth
			new SolarSystemPlanetCharacteristics(3396000, "#d9480f"), //Mars
			new SolarSystemPlanetCharacteristics(71492000, "#e67700"), //Jupiter
			new SolarSystemPlanetCharacteristics(60268000, "#ffc078"), //Saturn
			new SolarSystemPlanetCharacteristics(25559000, "#74c0fc"), //Uranus
